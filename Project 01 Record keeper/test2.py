...
listbox = Listbox(top)
# listbox.configure(side = LEFT,expand=True,fill=BOTH)

listbox.configure(background="black", foreground="LightCyan3", font=('"Consolas" 13'))

  
listbox.insert(1,"[ASSISTANT] -> India")  
  
listbox.insert(2, "[-ASSISTANT-] --> USA")  
  
listbox.insert(3, "[ USER ] : User sJapan")  
  
listbox.insert(4, "USER SAID --> corporation")  
...
'''
FONTS AVAILABLE IN TKINTER LIST IS BELOW
